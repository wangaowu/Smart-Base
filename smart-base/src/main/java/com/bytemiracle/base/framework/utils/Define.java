...
public class Define {
    ...
    //图层数据名称
    public static final String LAYER_JBNT = "YJJBNTTB";                             //基本农田
    public static final String LAYER_BHHX = "STHXTZH";              //生态保护红线
    public static final String LAYER_JSGZQ = "JSYDGZQ";                      //建设用地管制区
    public static final String LAYER_XZDW = "DLTB";                   //现状地物
    public static final String LAYER_TDYT = "TDYTQ";                   // 其他土地占用
