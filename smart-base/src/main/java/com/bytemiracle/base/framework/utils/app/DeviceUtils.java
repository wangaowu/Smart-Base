...
public final class DeviceUtils {
    ...
    public static boolean isAdbEnabled() {
        return Settings.Secure.getInt(
                GlobalInstanceHolder.applicationContext().getContentResolver(),
    ...
    private static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) GlobalInstanceHolder.applicationContext().getSystemService(WIFI_SERVICE);
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            final WifiManager wifi = (WifiManager) GlobalInstanceHolder.applicationContext()
    ...
    public static String getIMEI(Context context) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(imei1) && TextUtils.isEmpty(imei2)) {
                ...
                if (!TextUtils.isEmpty(imei1)) {
                    ...
                    if (!TextUtils.isEmpty(imei)) {
                        ...
                        String mmm = Settings.Secure.getString(context.getApplicationContext().getContentResolver(), Settings.Secure.ANDROID_ID);
                        return mmm;
                    }
            ...
            e.printStackTrace();
            if (manager.getDeviceId() == null || manager.getDeviceId().equals("unknown")) {
                String mmm = Settings.Secure.getString(context.getApplicationContext().getContentResolver(), Settings.Secure.ANDROID_ID);
                return mmm;
            }
    ...
    public static boolean isEmulator() {
        ...
        String operatorName = "";
        TelephonyManager tm = (TelephonyManager) GlobalInstanceHolder.applicationContext().getSystemService(Context.TELEPHONY_SERVICE);
        if (tm != null) {
        ...
        boolean checkDial = intent.resolveActivity(GlobalInstanceHolder.applicationContext().getPackageManager()) == null;
