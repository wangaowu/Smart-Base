package com.bytemiracle.base.framework.utils.encrypt;
...
public final class AesCryptUtil {
    ...
    private static String CLIPPER = "AES_DEFINED";
     ...
     * @param clipper
     */
    public static void initCustomAESClipper(String clipper) {
        AesCryptUtil.CLIPPER = clipper;
    }
    ...
    public static String encrypt(String message)
        ...
        try {
            final SecretKeySpec key = generateKey(CLIPPER);
